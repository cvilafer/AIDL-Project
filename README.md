...
The "video_root_folder" has to point to the original video test files (the above links from dropbox). Is needed to generate the output frame images.

The "original_csv_folder" has to point to the subfolder "mp1000" from the videos_test folder, where are the csv's without processing. Is needed also to generate the output frame images.
